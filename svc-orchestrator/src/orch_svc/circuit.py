"""Circuit breaker por downstream (padrão AI-Orchestrator).

3 falhas de transporte → OPEN por reset_s → half-open. 4xx NÃO conta.
"""
...
class DownstreamBusiness(Exception):
    """Erro 4xx do downstream (NÃO conta para o circuito)."""
...
class CircuitOpen(Exception):
    """Circuito OPEN — chamada recusada sem bater no downstream."""
